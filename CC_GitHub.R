...
ICtab(M1,M2,base=T,type="AICc",weights=T)
...
plotrix::plotCI(x=0.75,y=0.06,li=-0.77,ui=0.90,pch=16,xlim=c(0.5,5.5),ylim=c(-2.5,1),xaxt='n',xlab='Model',ylab="% change in pop. growth rate",col="orange")
abline(h=-1,lty=3)
abline(h=0,lty=)
...
axis(1,at=1:5,labels=c("1.RGB_A_Y","2.RGB_D_YI","3.D_YM","4.D_YI","Raw means"),cex.axis=1)
